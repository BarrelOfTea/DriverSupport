package com.barreloftea.driversupport.bleservice.miband;
...
import com.barreloftea.driversupport.bleservice.miband.listeners.NotifyListener;
import com.barreloftea.driversupport.bleservice.miband.listeners.RealtimeStepsNotifyListener;
import com.barreloftea.driversupport.bleservice.miband.model.BatteryInfo;
import com.barreloftea.driversupport.bleservice.miband.model.LedColor;
import com.barreloftea.driversupport.bleservice.miband.model.Profile;
import com.barreloftea.driversupport.bleservice.miband.model.Protocol;
import com.barreloftea.driversupport.bleservice.miband.model.UserInfo;
import com.barreloftea.driversupport.bleservice.miband.model.VibrationMode;
...
public class MiBand {
    ...
    public void setHeartRateScanListener(final HeartRateNotifyListener listener) {
        this.io.setNotifyListener(Profile.UUID_SERVICE_HEARTRATE, Profile.UUID_NOTIFICATION_HEARTRATE, new NotifyListener() {
            ...
            public void onNotify(byte[] data) {
                Log.d(TAG, Arrays.toString(data));
                //NOTICE why does the developer check for data[0]==6
