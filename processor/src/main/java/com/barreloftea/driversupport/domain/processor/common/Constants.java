...
public class Constants {
    ...
    public static final String RTSP_LINK = "rtsp_link";
    public static final String RTSP_USERNAME = "rtsp_username";
    public static final String RTSP_PASSWORD = "rtsp_password";
